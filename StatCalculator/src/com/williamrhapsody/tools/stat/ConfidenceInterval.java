...
public class ConfidenceInterval {
    ...
    public ConfidenceInterval(int accuracy) {
        this();
    ...
    public final StatResult one_prop_z_interval(final long x, final long N, final double CL) {
        ...
        double critical_level = distribution.invNorm_Standard(CL + (1 - CL) / 2);
    ...
    public final StatResult one_sample_t_interval(final long xBar, final double Sx, final long N, final double CL) {
        ...
        double criticalValue = distribution.invT(CL + (1 - CL) / 2, N - 1);
     ...
     * @return 置信区间
     */
    public final StatResult two_sample_t_interval(final long x1Bar, final double Sx1, final long n1, final long x2Bar, final double Sx2, final long n2, final double CL) {
        ...
        double criticalValue = distribution.invT(CL + (1 - CL) / 2, df);
        double margin_of_error = criticalValue * SE;
